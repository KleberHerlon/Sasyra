...
import { EvaSlider, TagSelect, SingleSelect, AudioField, CREFITO_REGIOES, useProgress, Section, Row, Field, SubHeading } from "./components";
...
export default function Sasyra() {
  ...
  const loadAssessment = (a) => {
    ...
    setForca(a.forca||{quadricepsD:"",quadricepsE:"",isquiotibialD:"",isquiotibialE:"",gluteoD:"",gluteoE:"",manguitoD:"",manguitoE:"",tibialAnterior:"",gastrocnemio:"",bicepsD:"",bicepsE:""});
  ...
  const resetAssessment = () => {
    ...
    setReflexos(""); setForca({quadricepsD:"",quadricepsE:"",isquiotibialD:"",isquiotibialE:"",gluteoD:"",gluteoE:"",manguitoD:"",manguitoE:"",tibialAnterior:"",gastrocnemio:"",bicepsD:"",bicepsE:""});
        ...
        {tab==="relatorio" && (
          <Section title="Relatório Multidisciplinar" icon="📊">
            <div style={{ background:"#fff", borderRadius:12, padding:28, color:"#1a202c", fontFamily:F }}>
              ...
              {currentLogs.length>0 && (
                <div style={{ marginBottom:18 }}>
                  <div style={{ fontWeight:700, color:"#0F6E56", fontSize:11, textTransform:"uppercase", letterSpacing:"0.1em", marginBottom:10 }}>Evolução — {currentLogs.length} sessão(ões)</div>
