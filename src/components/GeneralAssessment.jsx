...
export default function GeneralAssessment({ storageKey, studentId, colors, onSave, initialBodyPain, pediatric, sex }) {
  ...
  return (
    <div style={{ background:colors.card, border:`1px solid ${colors.border}`, borderRadius:14, padding:"20px 22px", marginBottom:14 }}>
      ...
      <div style={{ marginBottom:14 }}>
        ...
        <BodyMap value={bodyPain} onChange={setBodyPain} colors={{ mark:accent, ...colors }} pediatric={pediatric} sex={sex} />
      </div>
