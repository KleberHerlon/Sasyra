...
export default function PatientIdentification({ student, onUpdate, regiao, setRegiao, hideAntropometria }) {
  const pt = student || {};
  ...
  return (
    <div style={{ fontFamily: F }}>
      <div style={{ fontSize: 12, fontWeight: 800, color: C.green, textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 14, borderBottom: `1px solid ${C.green}40`, paddingBottom: 8 }}>
      ...
      <div style={{ background: C.card, border: `1px solid ${C.borderLight}`, borderRadius: 10, padding: "14px 16px", marginBottom: 12 }}>
