...
- Name: sasyra.spec.js >> SASYRA E2E — Fluxo Completo >> 3. 💡 Botão Dicas está visível no módulo ortopédico
- Location: e2e\sasyra.spec.js:93:3
...
Locator: locator('button:has-text("Dicas")').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Dicas")').first()
