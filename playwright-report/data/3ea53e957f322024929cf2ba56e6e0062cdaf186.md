...
- Name: sasyra.spec.js >> SASYRA E2E — Fluxo Completo >> 7. 👤 Identificação do Paciente é colapsável
- Location: e2e\sasyra.spec.js:142:3
...
Locator: locator('h3:has-text("Identificação")').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text("Identificação")').first()
